...
def insert_publisher(connection, publisher_data):
    ...
    with connection.cursor() as cursor:
        ...
        """)
        cursor.execute(insert_query, (publisher_data['name'], publisher_data['founded_year'], publisher_data['country_code']))
...
def main():
    ...
    for book in google_books_data:
        if publisher_id:
            genre_id = None  # Assume genre data is handled elsewhere or statically defined
